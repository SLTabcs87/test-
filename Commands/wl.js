        ...
        if(!args[0]){
            ...
            message.guild.channels.create(target.user.username, {type: "text", permissionOverwrites: [
                ...
                channel.send(new Discord.MessageEmbed() 
                    ...
                    Rappelez-vous que vous devez avoir un ou plusieurs tokens de bot pour utiliser Dmall, si vous n'avez pas encore de token, adressez-vous à un helper pour en savoir plus.`)
                    .setColor(config.embedColor)
                )
    
                channel.send(new Discord.MessageEmbed() 
                    .setTitle("Utilisation de Dmall")
                    .setDescription("__Voici les commandes que vous pouvez utiliser avec Dmall:__")
